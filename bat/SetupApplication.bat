...
:: Android packaging
set AND_CERT_NAME="WizardsAndWanders"
set AND_CERT_PASS=alexsucks
set AND_CERT_FILE=cert\WizardsAndWanders.p12
...
set IOS_PROVISION=cert\WizardsAndWanders.mobileprovision
...
set APP_ID=air.WizardsAndWanders
