...
package com.as3toolkit.ui {
	...
	public class Keyboarder extends EventDispatcher{
		...
		public function Keyboarder(aDO:DisplayObject):void
		{
			if(_instance != null)
			{
				// complain loudly that you've already created a Keyboarder once before!
				trace("HEY IDIOT! You already made a Keyboarder before!");
				trace("Prepare for unexpected results!");
			} else {
